...
export interface InitOutput {
    ...
    readonly computeMinPeginFee: (a: number, b: number, c: bigint) => [bigint, number, number];
    ...
    readonly wasmprepegintx_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: bigint, o: bigint, p: number, q: number, r: number, s: number, t: number, u: number, v: number) => [number, number, number];
